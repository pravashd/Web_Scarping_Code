...
f = csv.writer(open('xyzwww-chamberr.csv', 'w'))
f.writerow(['Links','First Name','Last Name', 'Address', 'Phone Number', 'EmailAddress','Web Address','About','Industry-Sector'])
...
for urls in dash:
 ...
 for company in companysDatass:
     ...
     for about in soups.select('div[class="um-field um-field-about um-field-textarea um-field-type_textarea"]'):
         about = about.text  
     for industry in soups.select('div[class="um-field-value"]'):
         industry = industry.text   
     info = [links,firstName,lastName,address,phoneNumber,emailAddress,webAddress,about,industry]
     print(info)
     f.writerow(info)      
