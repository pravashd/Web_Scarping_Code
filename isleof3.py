...
f = csv.writer(open('HH-isleofman_com.csv', 'w'))
f.writerow(['Links','Title','Address','Telephone','Category'])

dash = ["https://www.isleofman.com/directory/AToZ/H"]
for urls in dash:
 ...
 for company in companysData:
     links = 'https://www.isleofman.com/directory/AToZ/H'+company.get('href') 
     ...
     for company12345 in companysData123:
        links456 = 'https://www.isleofman.com/directory/AToZ/H'+company12345.get('href') 
