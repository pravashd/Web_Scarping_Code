...
for urls in url:
   ...
   for company in companysData:
	 ...
	 companyName = companysData.find('div[class="mw-1000"]> h1').text.replace('\n','')
	 companyWebsite = companysData.find('h2[class="web"]> a').text.replace('\n','')
	 companyPhone = companysData.find('div[class="mw-1000 flex"]').text.replace('\n','')
	 companyDescription = companysData.find('div[class="biz-detail-copy"]').text.replace('\n','')
